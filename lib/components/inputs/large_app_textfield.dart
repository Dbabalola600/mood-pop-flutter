...
class LargeAppTextField extends StatefulWidget {
  LargeAppTextField(
      {Key? key,
      this.label = "",
      this.hint = "",
  ...
  @override
  State<LargeAppTextField> createState() => _AppTextFieldState();
}

class _AppTextFieldState extends State<LargeAppTextField> {
